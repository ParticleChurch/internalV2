...
public:
	...
	{
		CallVFunc<void>(this, 11, bEnable);
	}

	bool IsButtonDown(EButtonCode buttonCode)
	{
		return CallVFunc<bool>(this, 15, buttonCode);
	}
	...
	{
		return CallVFunc<const char*>(this, 40, buttonCode);
	}

	EButtonCode VirtualKeyToButtonCode(int iVirtualKey)
	{
		return CallVFunc<EButtonCode>(this, 45, iVirtualKey);
	}
	...
	int VirtualKeyToButtonCode2(int virtualKey) noexcept
	{
